...
const IOS_NOTE: Record<Language, Section> = {
  ...
  bn: {
    ...
    content:
      ...
      '• আযানের শব্দ — নামাজের সময় আপনি একটি নোটিফিকেশন পাবেন। লক স্ক্রিনে আযান সর্বোচ্চ ৩০ সেকেন্ড বাজে। সম্পূর্ণ আযান শুনতে নোটিফিকেশনে ট্যাপ করুন — নোটিফিকেশনেও এটি লেখা থাকে। আপনি যদি সাধারণত শুধু অ্যাপ আইকন খোলেন, তাহলে EEIS মাসে সর্বোচ্চ একবার মনে করিয়ে দেয় (ইনস্টল করার প্রথম দুই সপ্তাহে কখনো নয়)।\n\n' +
  ...
  ar: {
    ...
    content:
      ...
      '• صوت الأذان — في وقت الصلاة يصلك إشعار. على شاشة القفل يُشغَّل الأذان لمدة تصل إلى 30 ثانية. اضغط على الإشعار لسماع الأذان كاملًا — الإشعار نفسه يذكّرك بذلك أيضًا. إذا اعتدت فتح أيقونة التطبيق فقط، يذكّرك EEIS بلطف مرة واحدة في الشهر على الأكثر (ليس أبدًا خلال أول أسبوعين بعد التثبيت).\n\n' +
