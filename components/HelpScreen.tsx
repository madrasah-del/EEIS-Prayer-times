...
const IOS_NOTE: Record<Language, Section> = {
  en: {
    ...
    content:
      ...
      '• QUOTES — The Quran/Hadith quote is NOT shown in the notification on iPhone (notifications cut it off). Instead the full quote scrolls across the green bar on the main screen and changes each prayer. TAP the green bar — or open the app from a prayer notification — to see the full quote (with surah name and number) and the prayer’s Adhan + Iqamah times in a large pop-up box.\n\n' +
  ...
  ur: {
    ...
    content:
      ...
      '• الرٹ کے اختیارات — اسکرین فلیش، ٹارچ، وائبریٹ اور لوپ آئی فون پر نہیں دکھائے جاتے، کیونکہ ایپل ایپس کو الارم کے لیے ان کی اجازت نہیں دیتا۔ آئی فون پر ہر نماز کے لیے صرف آواز اور اقتباس کا اختیار ہوتا ہے۔\n\n' +
      '• فل اسکرین الارم — آئی فون پر آپ کو نوٹیفیکیشن ملتا ہے، اینڈرائیڈ کی طرح فل اسکرین نہیں۔\n\n' +
      '• اقتباسات — آئی فون پر قرآن/حدیث کا اقتباس نوٹیفیکیشن میں نہیں دکھایا جاتا (نوٹیفیکیشن اسے کاٹ دیتا ہے)۔ اس کے بجائے مکمل اقتباس مرکزی اسکرین کے سبز بار پر چلتا ہے اور ہر نماز پر بدلتا ہے۔ مکمل اقتباس (سورہ کے نام اور نمبر کے ساتھ) اور نماز کے اذان و اقامہ اوقات بڑے پاپ اپ میں دیکھنے کے لیے سبز بار پر ٹیپ کریں یا نوٹیفیکیشن سے ایپ کھولیں۔\n\n' +
  ...
  bn: {
    ...
    content:
      ...
      '• অ্যালার্ট অপশন — স্ক্রিন ফ্ল্যাশ, টর্চ, ভাইব্রেট ও লুপ আইফোনে দেখানো হয় না, কারণ অ্যাপল অ্যালার্মের জন্য এগুলো করতে দেয় না। আইফোনে প্রতিটি নামাজের জন্য কেবল শব্দ ও উদ্ধৃতি অপশন থাকে।\n\n' +
      '• ফুল-স্ক্রিন অ্যালার্ম — আইফোনে আপনি একটি নোটিফিকেশন পাবেন, অ্যান্ড্রয়েডের মতো ফুল-স্ক্রিন নয়।\n\n' +
      '• উদ্ধৃতি — আইফোনে কোরআন/হাদিসের উদ্ধৃতি নোটিফিকেশনে দেখানো হয় না (নোটিফিকেশন তা কেটে দেয়)। বদলে সম্পূর্ণ উদ্ধৃতি মূল স্ক্রিনের সবুজ বারে স্ক্রল করে এবং প্রতিটি নামাজে পরিবর্তিত হয়। সম্পূর্ণ উদ্ধৃতি (সূরার নাম ও নম্বরসহ) এবং নামাজের আযান ও ইকামাহ সময় বড় পপ-আপে দেখতে সবুজ বারে ট্যাপ করুন বা নোটিফিকেশন থেকে অ্যাপ খুলুন।\n\n' +
  ...
  ar: {
    ...
    content:
      ...
      '• خيارات التنبيه — وميض الشاشة والمصباح والاهتزاز والتكرار لا تظهر على الآيفون، لأن آبل لا تسمح للتطبيقات بها للمنبهات. على الآيفون لكل صلاة خيار الصوت والاقتباس فقط.\n\n' +
      '• منبّه ملء الشاشة — على الآيفون تحصل على إشعار، وليس استحواذًا على ملء الشاشة كما في أندرويد.\n\n' +
      '• الاقتباسات — لا يظهر اقتباس القرآن/الحديث في الإشعار على الآيفون (الإشعار يقتطعه). بدلًا من ذلك يمر الاقتباس كاملًا على الشريط الأخضر في الشاشة الرئيسية ويتغيّر مع كل صلاة. اضغط على الشريط الأخضر — أو افتح التطبيق من إشعار الصلاة — لرؤية الاقتباس كاملًا (مع اسم السورة ورقمها) وأوقات الأذان والإقامة للصلاة في صندوق منبثق كبير.\n\n' +
