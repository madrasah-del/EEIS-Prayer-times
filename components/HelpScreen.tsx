...
const IOS_NOTE: Record<Language, Section> = {
  ...
  ur: {
    ...
    content:
      ...
      '• اقتباسات — آئی فون پر قرآن/حدیث کا اقتباس نوٹیفیکیشن میں نہیں دکھایا جاتا (نوٹیفیکیشن اسے کاٹ دیتا ہے)۔ اس کے بجائے مکمل اقتباس مرکزی اسکرین کے سبز بار پر چلتا ہے اور ہر نماز پر بدلتا ہے۔ مکمل اقتباس (سورہ کے نام اور نمبر کے ساتھ) بڑے پاپ اپ میں دیکھنے کے لیے سبز بار پر ٹیپ کریں یا نوٹیفیکیشن سے ایپ کھولیں۔\n\n' +
  ...
  bn: {
    ...
    content:
      ...
      '• উদ্ধৃতি — আইফোনে কোরআন/হাদিসের উদ্ধৃতি নোটিফিকেশনে দেখানো হয় না (নোটিফিকেশন তা কেটে দেয়)। বদলে সম্পূর্ণ উদ্ধৃতি মূল স্ক্রিনের সবুজ বারে স্ক্রল করে এবং প্রতিটি নামাজে পরিবর্তিত হয়। সম্পূর্ণ উদ্ধৃতি (সূরার নাম ও নম্বরসহ) বড় পপ-আপে দেখতে সবুজ বারে ট্যাপ করুন বা নোটিফিকেশন থেকে অ্যাপ খুলুন।\n\n' +
  ...
  ar: {
    ...
    content:
      ...
      '• الاقتباسات — لا يظهر اقتباس القرآن/الحديث في الإشعار على الآيفون (الإشعار يقتطعه). بدلًا من ذلك يمر الاقتباس كاملًا على الشريط الأخضر في الشاشة الرئيسية ويتغيّر مع كل صلاة. اضغط على الشريط الأخضر — أو افتح التطبيق من إشعار الصلاة — لرؤية الاقتباس كاملًا (مع اسم السورة ورقمها) في صندوق منبثق كبير.\n\n' +
