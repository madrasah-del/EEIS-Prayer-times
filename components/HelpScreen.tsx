...
const IOS_NOTE: Record<Language, Section> = {
  en: {
    ...
    content:
      ...
      '• ADHAN SOUND — At prayer time you get a notification. On the lock screen the adhan plays for up to 30 seconds. TAP the notification to open the app and hear the FULL adhan — the notification itself says this too.\n\n' +
  ...
  ur: {
    ...
    content:
      ...
      '• اذان کی آواز — نماز کے وقت آپ کو ایک نوٹیفیکیشن ملتا ہے۔ لاک اسکرین پر اذان زیادہ سے زیادہ 30 سیکنڈ چلتی ہے۔ مکمل اذان سننے کے لیے نوٹیفیکیشن پر ٹیپ کریں — نوٹیفیکیشن خود بھی یہی بتاتا ہے۔\n\n' +
  ...
  bn: {
    ...
    content:
      ...
      '• আযানের শব্দ — নামাজের সময় আপনি একটি নোটিফিকেশন পাবেন। লক স্ক্রিনে আযান সর্বোচ্চ ৩০ সেকেন্ড বাজে। সম্পূর্ণ আযান শুনতে নোটিফিকেশনে ট্যাপ করুন — নোটিফিকেশনেও এটি লেখা থাকে।\n\n' +
  ...
  ar: {
    ...
    content:
      ...
      '• صوت الأذان — في وقت الصلاة يصلك إشعار. على شاشة القفل يُشغَّل الأذان لمدة تصل إلى 30 ثانية. اضغط على الإشعار لسماع الأذان كاملًا — الإشعار نفسه يذكّرك بذلك أيضًا.\n\n' +
