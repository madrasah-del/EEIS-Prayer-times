...
const EN: Section[] = [
  ...
  // ── Setup Wizard ───────────────────────────────────────────────────────────
  {
    ...
    content:
      'The very first time you install the app (or reinstall it), a short wizard walks you through ' +
      'each prayer, one screen at a time — you can try each sound before choosing it, and every ' +
      'option (Notify, Quran quote, Loop, and on Android, Screen Flash/Camera Flash/Vibrate) is ' +
      'explained in plain English.\n\n' +
      'You do not have to finish it — "Skip" on the first screen leaves every prayer on the ' +
      'recommended defaults (Notify and Quran quote on, no sound). It only ever appears once; after ' +
      'that, your choices are remembered through every update. You can change anything at any time ' +
      'afterwards in Prayer Alerts & Sounds.',
  },
  // ── Prayer Alerts ──────────────────────────────────────────────────────────
  {
...
const UR: Section[] = [
  ...
  {
    title: '🧭 پہلی بار سیٹ اپ وزرڈ',
    content:
      'ایپ انسٹال کرنے (یا دوبارہ انسٹال کرنے) کے پہلے موقع پر، ایک مختصر وزرڈ آپ کو ہر نماز کے ذریعے ' +
      'ایک ایک اسکرین پر لے جاتا ہے — منتخب کرنے سے پہلے ہر آواز آزما سکتے ہیں، اور ہر آپشن (نوٹیفائی، ' +
      'قرآنی اقتباس، لوپ، اور اینڈرائیڈ پر اسکرین فلیش/کیمرہ فلیش/وائبریٹ) سادہ الفاظ میں سمجھایا جاتا ہے۔\n\n' +
      'اسے مکمل کرنا ضروری نہیں — پہلی اسکرین پر "Skip" ہر نماز کو تجویز کردہ ڈیفالٹ پر چھوڑ دیتا ہے ' +
      '(نوٹیفائی اور قرآنی اقتباس آن، کوئی آواز نہیں)۔ یہ صرف ایک بار ظاہر ہوتا ہے؛ اس کے بعد آپ کے ' +
      'انتخابات ہر اپڈیٹ میں محفوظ رہتے ہیں۔ آپ بعد میں کبھی بھی نماز الرٹس میں کچھ بھی بدل سکتے ہیں۔',
  },
  {
  ...
  },
  {
    ...
    content:
      ...
      '📖 اقتباسات — الارم اسکرین پر قرآن یا حدیث کا اقتباس (عربی اور انگریزی) ظاہر ہوتا ہے۔',
  },
  {
...
const BN: Section[] = [
  ...
  {
    title: '🧭 প্রথমবার সেটআপ উইজার্ড',
    content:
      'অ্যাপটি প্রথমবার ইনস্টল করার সময় (বা পুনরায় ইনস্টল করলে), একটি সংক্ষিপ্ত উইজার্ড আপনাকে প্রতিটি ' +
      'নামাজের মধ্য দিয়ে, একবারে একটি স্ক্রিন করে নিয়ে যায় — বেছে নেওয়ার আগে প্রতিটি শব্দ শুনে দেখতে পারবেন, ' +
      'এবং প্রতিটি অপশন (নোটিফাই, কুরআনের উক্তি, লুপ, এবং অ্যান্ড্রয়েডে স্ক্রিন ফ্ল্যাশ/ক্যামেরা ফ্ল্যাশ/ভাইব্রেট) ' +
      'সহজ ভাষায় ব্যাখ্যা করা হয়।\n\n' +
      'এটি শেষ করা বাধ্যতামূলক নয় — প্রথম স্ক্রিনে "Skip" প্রতিটি নামাজকে প্রস্তাবিত ডিফল্টে রেখে দেয় ' +
      '(নোটিফাই ও কুরআনের উক্তি চালু, কোনো শব্দ নেই)। এটি শুধু একবারই দেখা যায়; এরপর আপনার পছন্দ প্রতিটি ' +
      'আপডেটে মনে রাখা হয়। আপনি পরে যেকোনো সময় প্রার্থনা সতর্কতায় গিয়ে যেকোনো কিছু পরিবর্তন করতে পারেন।',
  },
  {
  ...
  },
  {
    ...
    content:
      ...
      '📖 উদ্ধৃতি — আলার্ম স্ক্রিনে কোরআন বা হাদিসের উদ্ধৃতি (আরবি ও ইংরেজি) দেখায়।',
  },
  {
...
const AR: Section[] = [
  ...
  },
  {
    ...
    content:
      'عند تثبيت التطبيق لأول مرة (أو إعادة تثبيته)، يرشدك معالج قصير عبر كل صلاة، شاشة تلو الأخرى — ' +
      'يمكنك تجربة كل صوت قبل اختياره، ويُشرح كل خيار (الإشعار، اقتباس القرآن، التكرار، وعلى أندرويد ' +
      'وميض الشاشة/المصباح/الاهتزاز) بلغة بسيطة.\n\n' +
      'لست مضطرًا لإنهائه — "تخطي" في الشاشة الأولى يترك كل صلاة على الإعدادات الموصى بها (الإشعار ' +
      'واقتباس القرآن مفعّلان، بلا صوت). يظهر مرة واحدة فقط؛ بعدها تُحفظ اختياراتك مع كل تحديث. يمكنك ' +
      'تغيير أي شيء لاحقًا في أي وقت من تنبيهات الصلاة.',
  },
  {
  ...
  },
  {
    ...
    content:
      ...
      '📖 الاقتباسات — تعرض آية قرآنية أو حديثًا (بالعربية والإنجليزية) على شاشة المنبّه (عند تفعيل وميض الشاشة) أو في قائمة الإشعارات.',
  },
  {
...
const IOS_NOTE: Record<Language, Section> = {
  en: {
    ...
    content:
      ...
      '• AUTOMATIC ON OPEN — If a prayer has Notify, Quote, or a Sound set, opening the app after that prayer shows its pop-up (valid until the next prayer) — a Sound always shows the pop-up too, since it is the only way to stop it on iPhone. Mosque announcements (campaigns) always show. A prayer with nothing set shows only on the main screen.\n\n' +
      '• ADHAN SOUND — At prayer time you get a notification. On the lock screen the adhan plays for up to 30 seconds. TAP the notification to open the app and hear the FULL adhan — the notification itself says this too. If you tend to just open the app icon instead, EEIS gently reminds you about tapping the notification at most once a month.\n\n' +
      '• SILENT SWITCH — If your iPhone is on silent, the adhan may be muted.\n\n' +
      '• ALERT OPTIONS — Screen Flash, Camera Flash and Vibrate are NOT shown on iPhone, because Apple does not allow apps to do them for alarms. Loop IS available on iPhone (loops the adhan sound until you tap Stop) — each prayer has a Sound, a Loop and a Quotes option.\n\n' +
  ...
  ur: {
    ...
    content:
      ...
      '• کھولنے پر خودکار — اگر کسی نماز کے لیے نوٹیفائی، اقتباس، یا آواز میں سے کوئی سیٹ ہو، تو اس نماز کے بعد ایپ کھولنے پر اس کا کارڈ دکھائی دے گا (اگلی نماز تک) — آواز ہمیشہ کارڈ دکھاتی ہے، کیونکہ آئی فون پر اسے روکنے کا یہی واحد طریقہ ہے۔ مسجد کے اعلانات ہمیشہ دکھائے جاتے ہیں۔ جس نماز میں کچھ بھی سیٹ نہ ہو وہ صرف مرکزی اسکرین پر نظر آتی ہے۔\n\n' +
      '• اذان کی آواز — نماز کے وقت آپ کو ایک نوٹیفیکیشن ملتا ہے۔ لاک اسکرین پر اذان زیادہ سے زیادہ 30 سیکنڈ چلتی ہے۔ مکمل اذان سننے کے لیے نوٹیفیکیشن پر ٹیپ کریں — نوٹیفیکیشن خود بھی یہی بتاتا ہے۔ اگر آپ عام طور پر صرف ایپ آئیکن کھولتے ہیں، تو EEIS مہینے میں زیادہ سے زیادہ ایک بار نرمی سے یاد دلاتا ہے کہ نوٹیفیکیشن پر ٹیپ کریں۔\n\n' +
      '• سائلنٹ سوئچ — اگر آپ کا آئی فون سائلنٹ پر ہے تو اذان خاموش ہو سکتی ہے۔\n\n' +
      '• الرٹ کے اختیارات — اسکرین فلیش، ٹارچ اور وائبریٹ آئی فون پر نہیں دکھائے جاتے، کیونکہ ایپل ایپس کو الارم کے لیے ان کی اجازت نہیں دیتا۔ لوپ آئی فون پر دستیاب ہے (اذان کی آواز کو اس وقت تک دہراتا ہے جب تک آپ Stop نہ دبائیں) — ہر نماز کے لیے آواز، لوپ اور اقتباس کا اختیار ہوتا ہے۔\n\n' +
      '• فل اسکرین الارم — آئی فون پر آپ کو نوٹیفیکیشن ملتا ہے، اینڈرائیڈ کی طرح فل اسکرین نہیں۔\n\n' +
      '• اقتباسات — آئی فون پر قرآن/حدیث کا اقتباس نوٹیفیکیشن میں نہیں دکھایا جاتا (نوٹیفیکیشن اسے کاٹ دیتا ہے)۔ اس کے بجائے، جب الارم بجتا ہے — یا آپ نوٹیفیکیشن سے ایپ کھولتے ہیں — تو ایک پوری اسکرین کارڈ نماز کا نام، اذان و اقامہ اوقات اور مکمل اقتباس (سورہ کے نام اور نمبر کے ساتھ) دکھاتا ہے۔\n\n' +
  ...
  bn: {
    ...
    content:
      ...
      '• খোলার সময় স্বয়ংক্রিয় — যদি কোনো নামাজের জন্য নোটিফাই, উদ্ধৃতি, বা শব্দ চালু থাকে, তাহলে সেই নামাজের পর অ্যাপ খুললে তার কার্ড দেখা যাবে (পরবর্তী নামাজ পর্যন্ত) — শব্দ সবসময় কার্ড দেখায়, কারণ আইফোনে এটি বন্ধ করার এটাই একমাত্র উপায়। মসজিদের ঘোষণা সবসময় দেখানো হয়। কিছুই সেট না থাকা নামাজ শুধু মূল স্ক্রিনে দেখা যায়।\n\n' +
      '• আযানের শব্দ — নামাজের সময় আপনি একটি নোটিফিকেশন পাবেন। লক স্ক্রিনে আযান সর্বোচ্চ ৩০ সেকেন্ড বাজে। সম্পূর্ণ আযান শুনতে নোটিফিকেশনে ট্যাপ করুন — নোটিফিকেশনেও এটি লেখা থাকে। আপনি যদি সাধারণত শুধু অ্যাপ আইকন খোলেন, তাহলে EEIS মাসে সর্বোচ্চ একবার নোটিফিকেশনে ট্যাপ করার কথা মনে করিয়ে দেয়।\n\n' +
      '• সাইলেন্ট সুইচ — আপনার আইফোন সাইলেন্ট থাকলে আযান নিঃশব্দ হতে পারে।\n\n' +
      '• অ্যালার্ট অপশন — স্ক্রিন ফ্ল্যাশ, টর্চ ও ভাইব্রেট আইফোনে দেখানো হয় না, কারণ অ্যাপল অ্যালার্মের জন্য এগুলো করতে দেয় না। লুপ আইফোনে পাওয়া যায় (Stop চাপা না দেওয়া পর্যন্ত আযানের শব্দ পুনরাবৃত্তি করে) — প্রতিটি নামাজের জন্য শব্দ, লুপ ও উদ্ধৃতি অপশন থাকে।\n\n' +
      '• ফুল-স্ক্রিন অ্যালার্ম — আইফোনে আপনি একটি নোটিফিকেশন পাবেন, অ্যান্ড্রয়েডের মতো ফুল-স্ক্রিন নয়।\n\n' +
      '• উদ্ধৃতি — আইফোনে কোরআন/হাদিসের উদ্ধৃতি নোটিফিকেশনে দেখানো হয় না (নোটিফিকেশন তা কেটে দেয়)। বদলে, যখন অ্যালার্ম বাজে — বা আপনি নোটিফিকেশন থেকে অ্যাপ খোলেন — তখন একটি ফুল-স্ক্রিন কার্ড নামাজের নাম, আযান ও ইকামাহ সময় এবং সম্পূর্ণ উদ্ধৃতি (সূরার নাম ও নম্বরসহ) দেখায়।\n\n' +
  ...
  ar: {
    ...
    content:
      ...
      '• تلقائيًا عند الفتح — إذا كان الإشعار أو الاقتباس أو الصوت مفعّلاً لصلاة ما، فسيظهر فتح التطبيق بعد تلك الصلاة بطاقتها (حتى الصلاة التالية) — الصوت يُظهر البطاقة دائمًا، لأنها الطريقة الوحيدة لإيقافه على الآيفون. تظهر إعلانات المسجد دائمًا. الصلاة التي لا يوجد بها أي إعداد تظهر فقط في الشاشة الرئيسية.\n\n' +
      '• صوت الأذان — في وقت الصلاة يصلك إشعار. على شاشة القفل يُشغَّل الأذان لمدة تصل إلى 30 ثانية. اضغط على الإشعار لسماع الأذان كاملًا — الإشعار نفسه يذكّرك بذلك أيضًا. إذا اعتدت فتح أيقونة التطبيق فقط، يذكّرك EEIS بلطف بالضغط على الإشعار مرة واحدة في الشهر على الأكثر.\n\n' +
      '• مفتاح الصامت — إذا كان هاتفك على الوضع الصامت فقد لا يُسمع الأذان.\n\n' +
      '• خيارات التنبيه — وميض الشاشة والمصباح والاهتزاز لا تظهر على الآيفون، لأن آبل لا تسمح للتطبيقات بها للمنبهات. التكرار متاح على الآيفون (يكرر صوت الأذان حتى تضغط إيقاف) — لكل صلاة خيار الصوت والتكرار والاقتباس.\n\n' +
      '• منبّه ملء الشاشة — على الآيفون تحصل على إشعار، وليس استحواذًا على ملء الشاشة كما في أندرويد.\n\n' +
      '• الاقتباسات — لا يظهر اقتباس القرآن/الحديث في الإشعار على الآيفون (الإشعار يقتطعه). بدلًا من ذلك، عند انطلاق المنبه — أو عند فتح التطبيق من إشعار الصلاة — تظهر بطاقة بملء الشاشة تعرض اسم الصلاة وأوقات الأذان والإقامة والاقتباس كاملًا (مع اسم السورة ورقمها).\n\n' +
