...
const IOS_NOTE: Record<Language, Section> = {
  en: {
    ...
    content:
      ...
      '• QUOTES — The Quran/Hadith quote is in the notification. Pull down or long-press the notification to expand it. The FULL quote of the day also scrolls across the green bar on the main screen, so you can always read it in full when the app is open.\n\n' +
  ...
  ur: {
    ...
    content:
      ...
      '• اقتباسات — قرآن/حدیث کا اقتباس نوٹیفیکیشن میں ہوتا ہے۔ پڑھنے کے لیے نوٹیفیکیشن کو نیچے کھینچیں یا دبا کر رکھیں۔ دن کا مکمل اقتباس مرکزی اسکرین کے سبز بار پر بھی چلتا ہے، تاکہ ایپ کھلی ہونے پر آپ اسے ہمیشہ مکمل پڑھ سکیں۔\n\n' +
  ...
  bn: {
    ...
    content:
      ...
      '• উদ্ধৃতি — কোরআন/হাদিসের উদ্ধৃতি নোটিফিকেশনে থাকে। পড়তে নোটিফিকেশনটি টেনে নামান বা চেপে ধরুন। দিনের সম্পূর্ণ উদ্ধৃতি মূল স্ক্রিনের সবুজ বারেও স্ক্রল করে, যাতে অ্যাপ খোলা থাকলে আপনি সবসময় পুরোটা পড়তে পারেন।\n\n' +
  ...
  ar: {
    ...
    content:
      ...
      '• الاقتباسات — اقتباس القرآن/الحديث موجود في الإشعار. اسحبه للأسفل أو اضغط عليه مطوّلًا لقراءته. كما يمر اقتباس اليوم كاملًا على الشريط الأخضر في الشاشة الرئيسية، لتتمكن دائمًا من قراءته كاملًا عند فتح التطبيق.\n\n' +
