...
const IOS_NOTE: Record<Language, Section> = {
  ...
  ur: {
    ...
    content:
      ...
      '• کھولنے پر خودکار — اگر آپ نے کوئی الرٹ سیٹ نہ بھی کیا ہو، نماز کے وقت کے بعد جب آپ ایپ کھولیں گے تو یہ خود بخود اُس نماز کا کارڈ (اور کوئی مسجد کا اعلان) دکھائے گا — تاکہ آپ سے نہ چھوٹے۔\n\n' +
  ...
  bn: {
    ...
    content:
      ...
      '• খোলার সময় স্বয়ংক্রিয় — কোনো অ্যালার্ট সেট না থাকলেও, নামাজের সময়ের পর অ্যাপ খুললে এটি স্বয়ংক্রিয়ভাবে সেই নামাজের কার্ড (এবং কোনো মসজিদের ঘোষণা) দেখাবে — যাতে আপনি মিস না করেন।\n\n' +
  ...
  ar: {
    ...
    content:
      ...
      '• تلقائيًا عند الفتح — حتى لو لم تضبط أي تنبيه، عند فتح التطبيق بعد وقت الصلاة سيعرض تلقائيًا بطاقة تلك الصلاة (وأي إعلان للمسجد) — حتى لا يفوتك.\n\n' +
